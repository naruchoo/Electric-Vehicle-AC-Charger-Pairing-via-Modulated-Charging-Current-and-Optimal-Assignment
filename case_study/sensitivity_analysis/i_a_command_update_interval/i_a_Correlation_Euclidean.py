...
# --- correlation-euclidean & matching ---
...
out_dir = os.path.join(
    os.getcwd(),
    "case_study/sensitivity_analysis/i_a_command_update_interval/accuracy/Correlation_Euclidean"
)
    ...
    for ev_interval in ev_intervals:
        for tau in taus:
            ...
            for offset in range(30):
                ...
                # Compute the Correlation-Euclidean score matrix (similarity / distance metric)
            ...
            fname = f"{num_patterns}_{ev_interval}sInterval_CorEuc_tau{tau}s_accuracy.csv"
